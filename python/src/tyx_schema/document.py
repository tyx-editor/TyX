...
#   timestamp: 2025-11-30T16:19:45+00:00
...
class TyXFunctionCallNode(BaseModel):
    ...
    positionParameters: Optional[
        List[Union["TyXLengthValue", "TyXBooleanValue", "PositionParameters"]]
    ] = None
    namedParameters: Optional[
        Dict[str, Union["TyXLengthValue", "TyXBooleanValue", "NamedParameters"]]
    ] = None
